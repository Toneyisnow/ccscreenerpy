...
x_axis_seq = []
test_points_seq = np.arange(8000, 14000, 50).tolist() 
...
np.save("D:/Temp/lstm_test/predictions", predictions_over_time)
np.save("D:/Temp/lstm_test/x_axis_seq", x_axis_seq)
